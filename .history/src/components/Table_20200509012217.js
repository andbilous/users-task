...
export default function TableComponent ({ users, setUserId }) {
  ...
  const handleChangeCount = (v) => {
    setItemCount(parseInt(v.value))
  }
  return (
    <React.Fragment>
      <Table size="small">
        <TableHead>
          <span>Values to show  : </span>
          <Select onChange={handleChangeCount} options = {options} />
          <TableRow>
            <TableCell>#</TableCell>
